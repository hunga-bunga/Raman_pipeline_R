...
#   PIPELINE COMPLETO: DATASET FT-RAMAN SrE.IR 
# ==============================================================================
...
# ------------------------------------------------------------------------------
# 6. CAPTURA E TREINO GLOBAL ATRAVÉS DAS FUNÇÕES DE MODELAÇÃO NATIVAS
# ------------------------------------------------------------------------------
cat("==================================================================\n")
cat("    6. EXECUÇÃO DO TREINO VIA TUAS FUNÇÕES ORIGINAIS (ML_raman)\n")
cat("==================================================================\n")

# --- MODELO A: RANDOM FOREST (FUNÇÃO NATIVA L2) ---
...
# --- MODELO B: SVM RADIAL (FUNÇÃO NATIVA L2) ---
...
# --- MODELO C: RANDOM FOREST (FUNÇÃO NATIVA MIN-MAX) ---
...
# --- MODELO D: SVM RADIAL (FUNÇÃO NATIVA MIN-MAX) ---
...
# Executar a nova visualização estatística no dataset SRE
